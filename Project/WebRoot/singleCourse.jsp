<%@ page language="java" contentType="text/html;" pageEncoding="UTF-8"
	import="com.cheating.hib.*" import="org.hibernate.Criteria"
	import="org.hibernate.Session" import="hibernate.*"
...
<body bgcolor="#FFCC66">
	...
	<div id="wrap">
		...
		<center>
			...
			<div class="returnRest">
				<a href="showRestaurant.jsp?id=<%=restId%>">到饭店逛逛~~</a>
			</div>

			<div class="pic">
				<img src=<%=String.valueOf(info.getPic())%> height="100px"
					width="100px" />
			</div>
			<div class="des">
				<%=info.getDescript()%>
			...
			<div class="putCart">
				...
				<form action="put_cart">
					<input type="hidden" name="id" id="id"
						value=<%=info.getCourseId()%>></input> <input type="text"
						name="course_count" vaule="1" id="course_count" size="3"></input>
