...
/**
 * AbstractCustomerinfo entity provides the base persistence definition of the Customerinfo entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractCustomerinfo  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractCustomerinfo(Logininfo logininfo, String telephoneNum, String firstName, String lastName, String email, Set reservationinfos, Set orderinfos) {
