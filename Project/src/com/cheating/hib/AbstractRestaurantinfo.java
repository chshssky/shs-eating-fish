...
/**
 * AbstractRestaurantinfo entity provides the base persistence definition of the Restaurantinfo entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractRestaurantinfo  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractRestaurantinfo(String name, String address, String descript, Integer managerUpBound, Set reservationinfos, Set managerinfos, Set courseinfos) {
        this.name = name;
        this.address = address;
