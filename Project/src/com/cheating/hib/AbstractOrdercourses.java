...
/**
 * AbstractOrdercourses entity provides the base persistence definition of the Ordercourses entity. @author MyEclipse Persistence Tools
 */
...
public abstract class AbstractOrdercourses  implements java.io.Serializable {
    ...
    /** full constructor */
    public AbstractOrdercourses(Courseinfo courseinfo, Orderinfo orderinfo, Integer num) {
