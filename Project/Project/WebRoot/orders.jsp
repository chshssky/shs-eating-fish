 ...
 <h1>Welcome to</h1><h2> your orders </h2><br/><h1>欢迎</h1><h2>查看</h2><h1>订单</h1>
    ...
    <%
		...
		for(Orderinfo info: orderinfos)
		{
			...
			if(info.getState().equals("处理中") || info.getState().equals("已完成"))
			{
			%>
				<div class="eachOrder">
				...
				<th colspan="1">订单生成时间：<%=String.valueOf(info.getOrderTime()) %></th>
				<th>总价格：<%=info.getSumPrice()%></th>
				<th>状态：<%=info.getState()%></th>
				<th>订餐电话：<%=info.getTelephoneNum()%></th>
				</tr>
				<tr> 
				...
				%>
							...
							<td align="center"><%=courseinfo.get(0).getRestaurantinfo().getName() %></td>
							</tr>
