...
2012/05/18
	F:我完成了订单功能，但orderinfo暂时没有commit到数据库，因为orderTime出了问题，不知道怎么回事，还要问问C...暂时还没有存用户地址，我后面会记得存上>_< 用户登出是不是要清空购物车呢？是滴~~..不用了~因为每次用户登陆都new了一个新的。。

2012/06/09
	F:嘿嘿~完成了manager~~~~
2012/06/10
	C:好久不写了。。。我改了数据库哈。。大家注意啦。。要重新生成一遍啦~~~还有google地图哦~~~
	C:终于写完了期待已久的google map。。。四个效果哦。。。加油。。。